...
export default function Page() { return <PropertyWizard><div className="bg-surface font-body-md text-white antialiased"><AddPropertySection0 /></div></PropertyWizard>; }
