...
export function PriceReview(){
  const { draft, setDraft, booking, preview: ctxPreview, setPreview: setCtxPreview } = useBooking();
  ...
  // Avoid hydration mismatch: server has no draft, client has draft from sessionStorage.
