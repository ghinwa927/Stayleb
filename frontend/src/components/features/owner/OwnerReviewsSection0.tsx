                  ...
                  {reviews.map((rev) => (
                    <article key={rev.id} className="review-item bg-surface-container-lowest rounded-xl p-space-lg shadow-sm hover:shadow transition-shadow flex flex-col md:flex-row gap-space-md">
                      ...
                      <div className="flex-1 flex flex-col justify-between gap-space-sm">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2 pt-space-xs">
                          <div className="flex items-center gap-2 text-on-surface-variant font-caption text-caption">
                            ...
                            {rev.moderation_status === "flagged" ? (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200 font-semibold text-xs">
                          ...
                          {rev.moderation_status === "flagged" ? (
                            <span className="text-xs text-amber-700 font-medium">Already reported</span>
                          ) : (
                            <button
                              onClick={() => {
                                setReportTarget(rev);
